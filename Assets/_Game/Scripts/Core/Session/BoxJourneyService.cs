...
{
    public sealed class BoxJourneyService : IBoxJourneyService
    {
        ...
        private static bool IsCollectable(CollectableGridCellData cell) => cell != null && cell.isFilled && cell.SpawnedObject != null;
